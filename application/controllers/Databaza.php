...
class Databaza extends CI_Controller {
    ...
    public function pouzivatelia()
    {
        ...
        $crud->display_as('kontakt','Telefónne číslo ')
    ...
    public function admin_pouzivatelia()
    {
    ...
    public function admin_poschodie()
    {
    ...
    public function prenajom()
    {
        ...
        $crud->display_as('poschodieID','Názov budovy');
        $crud->display_as('nazov','Názov prenájmu');
        $crud->display_as('m_stvrcovy','Rozloha (v m2)');
    ...
    public function admin_prenajom()
    {
